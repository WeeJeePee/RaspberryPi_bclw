...
while True:
    ...
    #Kleur wit
    low_white = np.array([87, 85, 80], dtype=np.uint8)
    up_white = np.array([120,118,112], dtype=np.uint8)
    #Inrages
    ...
    if lines is not None:
        for line in lines:
            ...
            x1, y1, x2, y2 = line[1]
            cv2.line(frame, (x1, y1), (x2, y2), (48, 255, 255), 20)
            x1, y1, x2, y2 = line[2]
            cv2.line(frame, (x1, y1), (x2, y2), (48, 255, 255), 20)
            x1, y1, x2, y2 = line[3]
            cv2.line(frame, (x1, y1), (x2, y2), (48, 255, 255), 20)
	...
	frameR = cv2.resize(lines_edges, (400,300))
	
	edgesR = cv2.resize(edges, (400,300))
