...
#Videocapture
video = cv2.VideoCapture("../../Video/template-matching/usa_videos/challenge_video.mp4")
i = 1
...
while True:
    ...
    vertices = np.array([[325,700],[450,450],[600,450],[600,450],[900,450],[1000,700],
                         ], np.int32)
    edges = roi(edges,[vertices])
    lines = cv2.HoughLinesP(edges, 1, np.pi/180, 50, maxLineGap=4)
