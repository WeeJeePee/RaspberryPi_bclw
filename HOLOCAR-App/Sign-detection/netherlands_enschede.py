...
files1= glob.glob('../../Video/template-matching/netherlands_enschede/image*.png')

for myfile in files1:
    image = cv2.imread(myfile,0)
    template_data.append(image)

test_image=cv2.imread('../../Video/template-matching/netherlands_enschede/enschede.png')
