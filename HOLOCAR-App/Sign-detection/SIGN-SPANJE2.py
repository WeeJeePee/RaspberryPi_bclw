...
cap = cv2.VideoCapture("../../Video/template-matching/spanje/section-spanje1.mp4")
template = cv2.imread("../../Video/template-matching/spanje/image157.png", cv2.IMREAD_GRAYSCALE)
template2 = cv2.imread("../../Video/template-matching/spanje/image136.png", cv2.IMREAD_GRAYSCALE)
...
while True:
    ...
    for pt in zip(*loc2[::-1]):
		cv2.rectangle(frame, pt, (pt[0] + w2, pt[1] + h2), (0, 255, 255), 3)
		number1 = 1;
		overlaySource = cv2.imread("../../Afbeeldingen/TrainingData/50km.png")
		overlay = cv2.resize(overlaySource, (50,100))
		rows,cols,channels = overlay.shape
