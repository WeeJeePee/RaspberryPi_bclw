...
cap = cv2.VideoCapture("../../Video/template-matching/spanje/section-spanje2.mp4")
template = cv2.imread("../../Video/template-matching/spanje/image164.png", cv2.IMREAD_GRAYSCALE)
template2 = cv2.imread("../../Video/template-matching/spanje/image25.png", cv2.IMREAD_GRAYSCALE)
#template3 = cv2.imread("../../Video/template-matching/spanje/image25.png", cv2.IMREAD_GRAYSCALE)
...
while True:
    ...
    for pt in zip(*loc[::-1]):
        ...
        cv2.putText(frame,'inhalen',(pt[0] + 10 + w, pt[1] + h), font, 1, (0,0,255), 1)
